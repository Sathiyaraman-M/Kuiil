...
namespace Kuiil.UI.Services.Ingestion;
    ...
    IVectorStore vectorStore)
{
    ...
    {
        var chunksCollection = vectorStore.GetCollection<Guid, IngestedChunk>("data-kuiil_ui-chunks");
        var documentsCollection = vectorStore.GetCollection<Guid, IngestedDocument>("data-kuiil_ui-documents");
